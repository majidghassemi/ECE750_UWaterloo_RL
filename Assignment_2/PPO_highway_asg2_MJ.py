...
if __name__ == "__main__":
    ...
    if train:
        ...
        model = PPO(
            ...
            verbose=2,
            tensorboard_log="highway_attention_ppo_intersection/",
        )
        # Train the agent
        model.learn(total_timesteps=150 * 1000)
        # Save the agent
        model.save("highway_attention_ppo_intersection/model")

    model = PPO.load("highway_attention_ppo_intersection/model")
